...
function createTodosListView(todosListViewModel) {
  let itemsList = todosListViewModel.todoListItemView
    .map((todoListItemViewModel) =>
      createTodoListItemView(todoListItemViewModel)
    )
...
function createTodoListItemView(todoListItemViewModel) {
  return /*html*/ `
      <div class="task ${
        ...
        <input type="text" class="task-field" readonly="" placeholder="${
          todoListItemViewModel.title
        }">
